...
export function GeneratePage() {
  ...
  return (
    <div className="cext-form">
      ...
      <NoticeAlert
        variant="info"
        message="Compatibility checks are advisory only. A mode marked not confirmed can still be tried."
      />
      ...
      <div>
        ...
        >
          {submitting ? <><span className="cext-spinner" style={{ width: 14, height: 14, borderWidth: 2 }} /> Running…</> : <><i className="fa fa-rocket" /> Deploy</>}
        </button>
        {(jobId || submitError) && (
