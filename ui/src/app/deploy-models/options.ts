...
export const FIELD_HELP = {
    ...
    publicModelName:
        'Name for this deployment. Becomes the served model name, the Git directory, and the Argo CD application. Lowercase letters, numbers and hyphens only (RFC 1123), e.g. "qwen3-32b-chat".',
