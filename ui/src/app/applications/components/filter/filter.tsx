...
export const Filter = (props: FilterProps) => {
    ...
    const filteredOptions = props.field
        ? labels
              .filter(l => !input || l.toLowerCase().includes(input.toLowerCase()))
              .map(l => {
    ...
    return (
        <div className='filter-dropdown' ref={ref}>
            <div className='filter-dropdown__trigger' onClick={() => setIsOpen(!isOpen)}>
                ...
                {props.selected.length > 0 && <span className='filter-dropdown__badge'>{props.selected.length}</span>}
            ...
            {isOpen && (
                <div className='filter-dropdown__menu'>
                    {props.loading ? (
                        <div className='filter-dropdown__status'>
                        ...
                        <div className='filter-dropdown__status filter-dropdown__status--error'>
                            ...
                            <span onClick={() => props.retry && props.retry()} className='filter-dropdown__retry'>
                                {' '}
                                Retry
                            </span>
                        </div>
                        ...
                        <>
                            ...
                            <div className='filter-dropdown__options'>
                                ...
                                {filteredOptions.length === 0 && <div className='filter-dropdown__empty'>No matches</div>}
                            </div>
